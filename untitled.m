...
% Last Modified by GUIDE v2.5 27-May-2022 15:32:48
...
hasil = mean([red,green,blue]);
set(handles.edit4, 'string', hasil);
if hasil < 100
    nilai  = 'Berwarna Gelap';
    set(handles.edit5, 'string', nilai);
elseif hasil > 100
    nilai = 'Berwarna Terang';
    set(handles.edit5, 'string', nilai);
end
guidata(hObject, handles);
